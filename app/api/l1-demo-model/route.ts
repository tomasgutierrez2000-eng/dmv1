...
const L1_OUTPUT_DIR = path.join(getProjectRoot(), 'scripts/l1/output');
const L2_OUTPUT_DIR = path.join(getProjectRoot(), 'scripts/l2/output');
const L3_OUTPUT_DIR = path.join(getProjectRoot(), 'scripts/l3/output');
