    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {/* L1 Layer */}
          <div className="bg-slate-800/50 border border-blue-500/30 rounded-xl p-8 backdrop-blur-sm hover:border-blue-500/50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-14 h-14 rounded-lg bg-blue-500/20 flex items-center justify-center">
                <Database className="w-7 h-7 text-blue-400" />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-blue-400">L1</h3>
          ...
          {/* L2 Layer */}
          <div className="bg-slate-800/50 border border-green-500/30 rounded-xl p-8 backdrop-blur-sm hover:border-green-500/50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-green-400">L2</h3>
          ...
          {/* L3 Layer */}
          <div className="bg-slate-800/50 border border-purple-500/30 rounded-xl p-8 backdrop-blur-sm hover:border-purple-500/50 transition-all">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-14 h-14 rounded-lg bg-purple-500/20 flex items-center justify-center">
                <BarChart3 className="w-7 h-7 text-purple-400" />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-purple-400">L3</h3>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-8 mb-16">
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8 flex-wrap">
            <div className="text-center">
              <div className="w-24 h-24 rounded-xl bg-blue-500/20 border-2 border-blue-500/50 flex items-center justify-center mb-3">
                <Database className="w-12 h-12 text-blue-400" />
              </div>
              <p className="font-semibold text-blue-400">L1 Reference</p>
            ...
            <div className="text-center">
              ...
              <p className="font-semibold text-green-400">L2 Snapshots</p>
              <p className="text-xs text-slate-400 mt-1">Time-series data</p>
            </div>
            <ArrowRight className="w-8 h-8 text-slate-500 flex-shrink-0" />
            <div className="text-center">
              <div className="w-24 h-24 rounded-xl bg-purple-500/20 border-2 border-purple-500/50 flex items-center justify-center mb-3">
                <BarChart3 className="w-12 h-12 text-purple-400" />
              </div>
              <p className="font-semibold text-purple-400">L3 Derived</p>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Facility Summary Walkthrough */}
            <div
              onClick={() => setActiveWalkthrough('facility-summary')}
              className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 cursor-pointer hover:border-blue-500/50 hover:bg-slate-800/70 transition-all group"
            >
            ...
            {/* Placeholder for future walkthroughs */}
            <div className="bg-slate-800/30 border border-slate-700/50 rounded-xl p-6 opacity-60">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-lg mb-1 text-slate-500">Lineage Flow</h4>
            ...
            <div className="bg-slate-800/30 border border-slate-700/50 rounded-xl p-6 opacity-60">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-lg mb-1 text-slate-500">Impact Analysis</h4>
                  <p className="text-sm text-slate-600">Coming soon</p>
                </div>
              </div>
              <p className="text-sm text-slate-600 mb-4">
