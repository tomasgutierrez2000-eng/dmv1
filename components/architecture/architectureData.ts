  ...
  nodes: [
    {
      ...
      detail: {
        ...
        items: [
          ...
          { name: 'facility_exposure_calc', note: 'derived overlay' },
        ],
  ...
  nodes: [
    {
      ...
      detail: {
        ...
        items: [
          ...
          { name: 'collateral_coverage_summary' },
          { name: 'facility_derived', note: 'dashboard dimension' },
          { name: 'counterparty_derived', note: 'dashboard dimension' },
          { name: '+ 71 more tables' },
        ],
        stats: [
          { label: 'Tables', value: '76' },
