      ...
      <SubSection id="platform-terms">
        ...
        <DataTable
          ...
          rows={[
            ...
            ['Rollup', 'How a metric aggregates from facility level up to portfolio/Business Segment level.'],
            ['Dimension', 'The level at which a metric is calculated: facility, counterparty, desk, portfolio, or Business Segment.'],
            ...
            ['BS', 'Business Segment — a major business division (e.g., Commercial Banking, Investment Banking).'],
