      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="bg-white rounded-lg border p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            The template includes an Instructions sheet and a Data Dictionary Reference sheet with all available tables and fields.
            Use the guide to help your AI fill out the template.
          </p>
          <div className="flex gap-3">
            ...
            >
              <FileText className="w-4 h-4" /> Download Template (.xlsx)
            </a>
            <a
