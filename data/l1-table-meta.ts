...
export const L1_TABLE_META: L1TableMeta[] = [
  ...
  // ── SCD-2 (Versioned) ──
  { name: 'counterparty', scd: 'SCD-2', category: 'Counterparty' },
  { name: 'legal_entity', scd: 'SCD-2', category: 'Legal Entity' },
  { name: 'instrument_master', scd: 'SCD-2', category: 'Instrument' },
  { name: 'credit_agreement_master', scd: 'SCD-2', category: 'Facility' },
  { name: 'facility_master', scd: 'SCD-2', category: 'Facility' },
  { name: 'contract_master', scd: 'SCD-2', category: 'Contract Identity' },
  { name: 'netting_agreement', scd: 'SCD-2', category: 'Netting & Margin' },
  { name: 'netting_set', scd: 'SCD-2', category: 'Netting & Margin' },
  { name: 'netting_set_link', scd: 'SCD-2', category: 'Netting & Margin' },
  { name: 'csa_master', scd: 'SCD-2', category: 'Netting & Margin' },
  { name: 'margin_agreement', scd: 'SCD-2', category: 'Netting & Margin' },
  ...
  { name: 'legal_entity_hierarchy', scd: 'SCD-2', category: 'Legal Entity' },
  { name: 'control_relationship', scd: 'SCD-2', category: 'Counterparty' },
  { name: 'economic_interdependence_relationship', scd: 'SCD-2', category: 'Counterparty' },
  ...
  { name: 'facility_lender_allocation', scd: 'SCD-2', category: 'Facility' },

  // ── Snapshot ──
  { name: 'counterparty_hierarchy', scd: 'Snapshot', category: 'Counterparty' },
