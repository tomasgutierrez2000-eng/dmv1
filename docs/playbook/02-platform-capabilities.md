...
The interactive visualizer renders all 212+ tables as draggable nodes on an SVG canvas, organized by L1/L2/L3 layers with color coding.
...
**Key features:**
- **110+ catalogue items** across 7 domains (Amendments, Capital, Exposure, Pricing, Profitability, Reference, Risk)
