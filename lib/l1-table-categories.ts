...
export const L1_TABLE_CATEGORIES: Record<string, string> = {
  ...
  risk_rating_tier_dim: 'Reference',
  dpd_bucket_dim: 'Reference',
  utilization_status_dim: 'Reference',
  origination_date_bucket_dim: 'Reference',
  pricing_tier_dim: 'Reference',
  internal_risk_rating_bucket_dim: 'Reference',
  // Date & time
  date_dim: 'Date & time',
  ...
  // Instrument (remaining from Entity masters after L2 migration)
  instrument_identifier: 'Instrument',
  // Collateral & CRM (Reference) — reference dims remaining after L2 migration
  collateral_eligibility_dim: 'Collateral & CRM (Reference)',
  collateral_haircut_dim: 'Collateral & CRM (Reference)',
  crm_eligibility_dim: 'Collateral & CRM (Reference)',
  risk_mitigant_type_dim: 'Collateral & CRM (Reference)',
  collateral_portfolio: 'Collateral & CRM (Reference)',
  // SCCL Grouping — remaining from Hierarchies & participation after L2 migration
  sccl_counterparty_group: 'SCCL Grouping',
  sccl_counterparty_group_member: 'SCCL Grouping',
  // Limits & Thresholds — remaining from Limits & FX after L2 migration
