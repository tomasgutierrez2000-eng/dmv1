...
export const RELEASE_ENTRIES: ReleaseEntry[] = [
  ...
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: '(new table)', changeType: 'Added', rationale: 'New L1 table added' },
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: 'hierarchy_id', changeType: 'Added', rationale: 'Field added to new L1.lob_hierarchy_config' },
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: 'hierarchy_name', changeType: 'Added', rationale: 'Field added to new L1.lob_hierarchy_config' },
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: 'hierarchy_type', changeType: 'Added', rationale: 'Field added to new L1.lob_hierarchy_config' },
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: 'root_segment_id', changeType: 'Added', rationale: 'Field added to new L1.lob_hierarchy_config' },
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: 'is_active', changeType: 'Added', rationale: 'Field added to new L1.lob_hierarchy_config' },
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: 'created_ts', changeType: 'Added', rationale: 'Field added to new L1.lob_hierarchy_config' },
  { date: '2026-03-05', layer: 'L1', table: 'lob_hierarchy_config', field: 'updated_ts', changeType: 'Added', rationale: 'Field added to new L1.lob_hierarchy_config' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: '(new table)', changeType: 'Added', rationale: 'New L1 table added' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'limit_assignment_id', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'limit_rule_id', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'facility_id', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'counterparty_id', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'lob_segment_id', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'assigned_limit_amt', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'effective_from_date', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'effective_to_date', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'is_active', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'created_ts', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'limit_assignment', field: 'updated_ts', changeType: 'Added', rationale: 'Field added to new L1.limit_assignment' },
  { date: '2026-03-05', layer: 'L1', table: 'pipeline_stage_dim', field: '(new table)', changeType: 'Added', rationale: 'New L1 table added' },
  { date: '2026-03-05', layer: 'L1', table: 'pipeline_stage_dim', field: 'pipeline_stage_code', changeType: 'Added', rationale: 'Field added to new L1.pipeline_stage_dim' },
  { date: '2026-03-05', layer: 'L1', table: 'pipeline_stage_dim', field: 'stage_name', changeType: 'Added', rationale: 'Field added to new L1.pipeline_stage_dim' },
  { date: '2026-03-05', layer: 'L1', table: 'pipeline_stage_dim', field: 'stage_order', changeType: 'Added', rationale: 'Field added to new L1.pipeline_stage_dim' },
  { date: '2026-03-05', layer: 'L1', table: 'pipeline_stage_dim', field: 'is_active', changeType: 'Added', rationale: 'Field added to new L1.pipeline_stage_dim' },
  { date: '2026-03-05', layer: 'L1', table: 'pipeline_stage_dim', field: 'description', changeType: 'Added', rationale: 'Field added to new L1.pipeline_stage_dim' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_pricing_snapshot', field: 'cost_of_funds_pct', changeType: 'Added', rationale: 'Field added to L2.facility_pricing_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: '(new table)', changeType: 'Added', rationale: 'New L2 table added' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'facility_id', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'as_of_date', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'counterparty_id', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'pd_pct', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'lgd_pct', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'ccf', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'ead_amt', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'expected_loss_amt', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'rwa_amt', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'risk_weight_pct', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'internal_risk_rating', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_risk_snapshot', field: 'currency_code', changeType: 'Added', rationale: 'Field added to new L2.facility_risk_snapshot' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: '(new table)', changeType: 'Added', rationale: 'New L2 table added' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'approval_id', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'facility_id', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'counterparty_id', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'as_of_date', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'approval_status', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'approval_date', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'approved_amount', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'exception_flag', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'exception_type', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'exception_type_code', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'exception_severity', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'exception_reason', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'approved_by', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
  { date: '2026-03-05', layer: 'L2', table: 'facility_credit_approval', field: 'expiry_date', changeType: 'Added', rationale: 'Field added to new L2.facility_credit_approval' },
