...
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (1, 1, 'WARNING', 1.25, '2024-01-01', 'Y', 'DSCR', 'Debt Service Coverage Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (2, 1, 'BREACH', 1.00, '2024-01-01', 'Y', 'DSCR', 'Debt Service Coverage Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (3, 2, 'WARNING', 0.75, '2024-01-01', 'Y', 'LTV', 'Loan-to-Value Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (4, 2, 'BREACH', 0.90, '2024-01-01', 'Y', 'LTV', 'Loan-to-Value Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (5, 3, 'WARNING', 1.50, '2024-01-01', 'Y', 'ICR', 'Interest Coverage Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (6, 3, 'BREACH', 1.00, '2024-01-01', 'Y', 'ICR', 'Interest Coverage Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (7, 4, 'WARNING', 4.00, '2024-01-01', 'Y', 'LEVERAGE', 'Total Leverage Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (8, 4, 'BREACH', 6.00, '2024-01-01', 'Y', 'LEVERAGE', 'Total Leverage Ratio', 'CREDIT') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (9, 5, 'WARNING', 1.20, '2024-01-01', 'Y', 'CURRENT_RATIO', 'Current Ratio', 'LIQUIDITY') ON CONFLICT (threshold_id) DO NOTHING;
INSERT INTO l1.metric_threshold (threshold_id, metric_definition_id, threshold_type, threshold_value, effective_from_date, active_flag, metric_code, metric_name, metric_category) VALUES (10, 5, 'BREACH', 1.00, '2024-01-01', 'Y', 'CURRENT_RATIO', 'Current Ratio', 'LIQUIDITY') ON CONFLICT (threshold_id) DO NOTHING;`;
