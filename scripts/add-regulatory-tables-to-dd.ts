...
const regulatoryTables = [
  // L1
  {
    ...
    fields: [
      ...
      { name: 'active_flag', description: 'Whether this record is currently active', data_type: 'BOOLEAN' },
  ...
  // L2
  {
    ...
    fields: [
      ...
      { name: 'significant_increase_flag', description: 'Whether a significant increase in credit risk was identified', data_type: 'BOOLEAN' },
      { name: 'credit_impaired_flag', description: 'Whether the exposure is credit-impaired', data_type: 'BOOLEAN' },
  ...
  // L3
  {
    ...
    fields: [
      ...
      { name: 'stage_transfer_flag', description: 'Whether a stage transfer occurred this period', data_type: 'BOOLEAN' },
