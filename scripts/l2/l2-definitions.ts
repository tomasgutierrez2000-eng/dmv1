/**
 * L2 table definitions: 28 tables (snapshots, events, attributions) for a GSIB-style bank.
...
export const L2_TABLES: L2TableDef[] = [
  // ----- Position & exposure -----
  {
    ...
    columns: [
      ...
      { name: 'instrument_id', type: 'BIGINT', nullable: true, fk: 'l2.instrument_master(instrument_id)' },
      ...
      { name: 'is_trading_banking_book_flag', type: 'CHAR(1)', nullable: true },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'ccf', type: 'DECIMAL(5,4)', nullable: true },
      ...
      { name: 'is_delinquent_payment_flag', type: 'CHAR(1)', nullable: true },
  ...
  },
  {
    ...
    scd: 'Snapshot',
    columns: [
      { name: 'netting_set_id', type: 'BIGINT', nullable: false, pk: true, fk: 'l2.netting_set(netting_set_id)' },
      { name: 'as_of_date', type: 'DATE', nullable: false, pk: true },
  ...
  },
  {
    ...
    scd: 'Snapshot',
    columns: [
      { name: 'collateral_asset_id', type: 'BIGINT', nullable: false, pk: true, fk: 'l2.collateral_asset_master(collateral_asset_id)' },
      { name: 'as_of_date', type: 'DATE', nullable: false, pk: true },
  ...
  // ----- Facility snapshots -----
  {
    ...
    columns: [
      ...
      { name: 'days_past_due', type: 'INTEGER', nullable: true },
      { name: 'is_watch_list_flag', type: 'CHAR(1)', nullable: true },
      { name: 'counterparty_id', type: 'BIGINT', nullable: true },
      { name: 'currency_code', type: 'VARCHAR(20)', nullable: true },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'rate_index_code', type: 'VARCHAR(20)', nullable: true },
      { name: 'is_pricing_exception_flag', type: 'CHAR(1)', nullable: true },
      { name: 'pricing_exception_status', type: 'VARCHAR(64)', nullable: true },
      { name: 'fee_rate_pct', type: 'DECIMAL(10,6)', nullable: true },
      { name: 'cost_of_funds_pct', type: 'DECIMAL(10,6)', nullable: true },
    ],
  },
  {
  ...
  },
  {
    ...
    scd: 'Snapshot',
    columns: [
      { name: 'payment_ledger_id', type: 'BIGINT', nullable: false, pk: true },
      { name: 'facility_id', type: 'BIGINT', nullable: false, fk: 'l2.facility_master(facility_id)' },
      { name: 'as_of_date', type: 'DATE', nullable: false },
      { name: 'payment_due_date', type: 'DATE', nullable: true },
      { name: 'payment_received_date', type: 'DATE', nullable: true },
      { name: 'payment_amount_due', type: 'DECIMAL(18,2)', nullable: true },
      { name: 'payment_applied_amt', type: 'DECIMAL(18,2)', nullable: true },
      { name: 'currency_code', type: 'VARCHAR(20)', nullable: true },
      { name: 'counterparty_id', type: 'BIGINT', nullable: true },
    ],
  },
  ...
  // See data/l3-tables.ts T54 and sql/l3/01_DDL_all_tables.sql
  {
  ...
  // ----- Ratings & metrics -----
  {
    ...
    columns: [
      ...
      { name: 'prior_rating_value', type: 'VARCHAR(20)', nullable: true },
      ...
      { name: 'rating_value', type: 'VARCHAR(20)', nullable: true },
  ...
  // See lib/l1-table-categories.ts and scripts/l1/output/ddl.sql
  {
  ...
  // See data/l3-tables.ts T53 and sql/l3/01_DDL_all_tables.sql
  {
  ...
  // ----- Risk parameters -----
  {
    tableName: 'facility_risk_snapshot',
    scd: 'Snapshot',
    columns: [
      { name: 'facility_id', type: 'BIGINT', nullable: false, pk: true, fk: 'l2.facility_master(facility_id)' },
      { name: 'as_of_date', type: 'DATE', nullable: false, pk: true },
      { name: 'counterparty_id', type: 'BIGINT', nullable: true, fk: 'l2.counterparty(counterparty_id)' },
      { name: 'pd_pct', type: 'DECIMAL(10,6)', nullable: true },
      { name: 'lgd_pct', type: 'DECIMAL(10,6)', nullable: true },
      { name: 'ccf', type: 'DECIMAL(6,4)', nullable: true },
      { name: 'ead_amt', type: 'DECIMAL(18,2)', nullable: true },
      { name: 'expected_loss_amt', type: 'DECIMAL(18,2)', nullable: true },
  ...
  // ----- Credit approval & exceptions -----
  {
    tableName: 'facility_credit_approval',
    scd: 'Event',
    columns: [
      { name: 'approval_id', type: 'BIGINT', nullable: false, pk: true },
      { name: 'facility_id', type: 'BIGINT', nullable: false, fk: 'l2.facility_master(facility_id)' },
      { name: 'counterparty_id', type: 'BIGINT', nullable: true, fk: 'l2.counterparty(counterparty_id)' },
      { name: 'as_of_date', type: 'DATE', nullable: false },
      { name: 'approval_status', type: 'VARCHAR(30)', nullable: true },
      { name: 'approval_date', type: 'DATE', nullable: true },
      { name: 'approved_amount', type: 'DECIMAL(18,2)', nullable: true },
      { name: 'is_exception_flag', type: 'CHAR(1)', nullable: true },
      { name: 'exception_type', type: 'VARCHAR(50)', nullable: true },
      { name: 'exception_type_code', type: 'VARCHAR(30)', nullable: true },
      { name: 'exception_severity', type: 'VARCHAR(30)', nullable: true },
      { name: 'exception_reason', type: 'VARCHAR(500)', nullable: true },
