...
CREATE TABLE IF NOT EXISTS l2.loan_position_detail (
  loan_position_detail_id BIGINT NOT NULL PRIMARY KEY,
  position_id BIGINT NOT NULL,
  as_of_date DATE NOT NULL,
  ...
  current_rate_pct NUMERIC(8,6),
  rate_index_code VARCHAR(30),
  spread_bps NUMERIC(8,2),
  original_balance_amt NUMERIC(18,2),
  current_balance_amt NUMERIC(18,2),
  funded_amount NUMERIC(18,2),
  unfunded_commitment_amt NUMERIC(18,2),
  days_past_due INTEGER,
  accrual_status VARCHAR(20),
  next_payment_date DATE,
  prepayment_penalty_flag CHAR(1),
  collateral_coverage_pct NUMERIC(10,4),
  covenant_compliance_flag CHAR(1),
  hqla_eligible_flag CHAR(1),
  lcr_outflow_category VARCHAR(50),
  nsfr_factor_pct NUMERIC(10,4),
  capital_risk_weight_pct NUMERIC(10,4),
  CONSTRAINT fk_loan_position_detail_position_id FOREIGN KEY (position_id) REFERENCES l2.position(position_id)
);

CREATE TABLE IF NOT EXISTS l2.derivative_position_detail (
  derivative_position_detail_id BIGINT NOT NULL PRIMARY KEY,
  position_id BIGINT NOT NULL,
  as_of_date DATE NOT NULL,
  derivative_type VARCHAR(50),
  derivative_subtype VARCHAR(50),
  underlying_asset_class VARCHAR(50),
  notional_amount NUMERIC(18,2),
  mark_to_market_amt NUMERIC(18,2),
  replacement_cost_amt NUMERIC(18,2),
  potential_future_exposure_amt NUMERIC(18,2),
  exposure_at_default_amt NUMERIC(18,2),
  cva_charge_amt NUMERIC(18,2),
  netting_set_id BIGINT,
  collateral_posted_amt NUMERIC(18,2),
  collateral_received_amt NUMERIC(18,2),
  initial_margin_amt NUMERIC(18,2),
  variation_margin_amt NUMERIC(18,2),
  settlement_type VARCHAR(20),
  clearing_method VARCHAR(30),
  is_centrally_cleared_flag CHAR(1),
  trade_date DATE,
  effective_date DATE,
  maturity_date DATE,
  sa_ccr_exposure_amt NUMERIC(18,2),
  capital_risk_weight_pct NUMERIC(10,4),
  lcr_outflow_category VARCHAR(50),
  CONSTRAINT fk_derivative_position_detail_position_id FOREIGN KEY (position_id) REFERENCES l2.position(position_id),
  CONSTRAINT fk_derivative_position_detail_netting_set_id FOREIGN KEY (netting_set_id) REFERENCES l1.netting_set(netting_set_id)
);

CREATE TABLE IF NOT EXISTS l2.sft_position_detail (
  sft_position_detail_id BIGINT NOT NULL PRIMARY KEY,
  position_id BIGINT NOT NULL,
  as_of_date DATE NOT NULL,
  sft_type VARCHAR(50),
  sft_subtype VARCHAR(50),
  cash_leg_amt NUMERIC(18,2),
  security_leg_amt NUMERIC(18,2),
  collateral_value_amt NUMERIC(18,2),
  haircut_applied_pct NUMERIC(10,4),
  margin_call_frequency VARCHAR(20),
  repo_rate_pct NUMERIC(8,6),
  netting_set_id BIGINT,
  settlement_date DATE,
  maturity_date DATE,
  is_open_maturity_flag CHAR(1),
  security_type VARCHAR(50),
  security_issuer_country VARCHAR(20),
  hqla_eligible_flag CHAR(1),
  lcr_inflow_category VARCHAR(50),
  nsfr_factor_pct NUMERIC(10,4),
  capital_risk_weight_pct NUMERIC(10,4),
  CONSTRAINT fk_sft_position_detail_position_id FOREIGN KEY (position_id) REFERENCES l2.position(position_id),
  CONSTRAINT fk_sft_position_detail_netting_set_id FOREIGN KEY (netting_set_id) REFERENCES l1.netting_set(netting_set_id)
);

CREATE TABLE IF NOT EXISTS l2.guarantee_lc_position_detail (
  guarantee_lc_detail_id BIGINT NOT NULL PRIMARY KEY,
  position_id BIGINT NOT NULL,
  as_of_date DATE NOT NULL,
  instrument_type VARCHAR(30),
  guarantee_type VARCHAR(50),
  lc_type VARCHAR(50),
  issued_amount NUMERIC(18,2),
  outstanding_amount NUMERIC(18,2),
  utilized_amount NUMERIC(18,2),
  credit_conversion_factor NUMERIC(10,6),
  beneficiary_counterparty_id BIGINT,
  expiry_date DATE,
  is_irrevocable_flag CHAR(1),
  is_financial_standby_flag CHAR(1),
  fee_rate_bps NUMERIC(8,2),
  lcr_outflow_category VARCHAR(50),
  capital_risk_weight_pct NUMERIC(10,4),
  CONSTRAINT fk_guarantee_lc_position_detail_position_id FOREIGN KEY (position_id) REFERENCES l2.position(position_id),
  CONSTRAINT fk_guarantee_lc_position_detail_beneficiary_counterparty_id FOREIGN KEY (beneficiary_counterparty_id) REFERENCES l1.counterparty(counterparty_id)
);

CREATE TABLE IF NOT EXISTS l2.bond_security_position_detail (
  bond_security_detail_id BIGINT NOT NULL PRIMARY KEY,
  position_id BIGINT NOT NULL,
  as_of_date DATE NOT NULL,
  security_type VARCHAR(50),
  ...
  isin VARCHAR(12),
  cusip VARCHAR(9),
  face_value_amt NUMERIC(18,2),
  market_value_amt NUMERIC(18,2),
  book_value_amt NUMERIC(18,2),
  accrued_interest_amt NUMERIC(18,2),
  unrealized_gain_loss_amt NUMERIC(18,2),
  coupon_rate_pct NUMERIC(8,6),
  coupon_frequency VARCHAR(20),
  maturity_date DATE,
  issuer_counterparty_id BIGINT,
  issuer_country_code VARCHAR(20),
  accounting_classification VARCHAR(30),
  hqla_level VARCHAR(10),
  hqla_eligible_flag CHAR(1),
  lcr_haircut_pct NUMERIC(10,4),
  nsfr_factor_pct NUMERIC(10,4),
  capital_risk_weight_pct NUMERIC(10,4),
  CONSTRAINT fk_bond_security_position_detail_position_id FOREIGN KEY (position_id) REFERENCES l2.position(position_id),
  CONSTRAINT fk_bond_security_position_detail_issuer_counterparty_id FOREIGN KEY (issuer_counterparty_id) REFERENCES l1.counterparty(counterparty_id)
);
