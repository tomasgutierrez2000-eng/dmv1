...
CREATE TABLE IF NOT EXISTS "l2"."position_detail" (
    ...
    "source_system_id" BIGINT,
    "raw_record_id" VARCHAR(200),
    "overdue_amt_current" NUMERIC(18,2),
    "overdue_amt_1_29" NUMERIC(18,2),
    "overdue_amt_30_59" NUMERIC(18,2),
    "overdue_amt_60_89" NUMERIC(18,2),
    "overdue_amt_90_plus" NUMERIC(18,2),
...
CREATE TABLE IF NOT EXISTS "l2"."facility_exposure_snapshot" (
    ...
    "internal_risk_rating_bucket_code" VARCHAR(50),
