...
-- ecl_allowance_movement (ECL/Impairment)
...
-- ecl_provision_calc (ECL/Impairment)
...
-- watchlist_movement_summary (Watchlist)
...
CREATE TABLE IF NOT EXISTS "l3"."exposure_metric_cube" (
    "exposure_metric_cube_sk" BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "l3"."risk_metric_cube" (
    "risk_metric_cube_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."counterparty_exposure_summary" (
    "counterparty_exposure_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."facility_exposure_summary" (
    "facility_exposure_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."portfolio_summary" (
    "portfolio_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."crm_allocation_summary" (
    "crm_allocation_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."collateral_portfolio_valuation" (
    "collateral_portfolio_valuation_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."limit_current_state" (
    "limit_current_state_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_ts" TIMESTAMP,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."limit_utilization_timeseries" (
    "limit_utilization_timeseries_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_ts" TIMESTAMP,
    "legal_entity_id" BIGINT,
    "limit_assignment_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."limit_attribution_summary" (
    "limit_attribution_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_ts" TIMESTAMP,
    "legal_entity_id" BIGINT,
    "limit_assignment_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."limit_breach_fact" (
    "limit_breach_fact_sk" BIGINT NOT NULL,
    "breach_id" BIGINT,
    "run_version_id" BIGINT,
    "limit_assignment_id" BIGINT,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."credit_event_summary" (
    "credit_event_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "counterparty_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."rating_migration_summary" (
    "rating_migration_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "counterparty_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."default_loss_recovery_summary" (
    "default_loss_recovery_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "counterparty_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."report_cell_value" (
    "report_cell_value_sk" BIGINT NOT NULL,
    "report_run_id" BIGINT,
    "cell_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."report_cell_contribution_fact" (
    "report_cell_contribution_fact_sk" BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "l3"."report_cell_rule_execution" (
    "report_cell_rule_execution_sk" BIGINT NOT NULL,
    "report_run_id" BIGINT,
    "cell_id" BIGINT,
    "rule_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."report_validation_result" (
    "report_validation_result_sk" BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "l3"."fr2590_position_snapshot" (
    "fr2590_position_snapshot_sk" BIGINT NOT NULL,
    "report_run_id" BIGINT,
    "position_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."fr2590_counterparty_aggregate" (
    "fr2590_counterparty_aggregate_sk" BIGINT NOT NULL,
    "report_run_id" BIGINT,
    "counterparty_id" BIGINT,
    "legal_entity_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_exposure_summary" (
    "lob_exposure_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_profitability_summary" (
    "lob_profitability_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_pricing_summary" (
    "lob_pricing_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_delinquency_summary" (
    "lob_delinquency_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_profitability_allocation_summary" (
    "lob_profitability_allocation_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."deal_pipeline_stage_summary" (
    "deal_pipeline_stage_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_credit_quality_summary" (
    "lob_credit_quality_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."kpi_period_summary" (
    "kpi_period_summary_sk" BIGINT NOT NULL,
    "kpi_code" VARCHAR(30),
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."risk_appetite_metric_state" (
    "risk_appetite_metric_state_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."executive_highlight_summary" (
    "executive_highlight_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."counterparty_detail_snapshot" (
    "counterparty_detail_snapshot_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "counterparty_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."limit_tier_status_matrix" (
    "limit_tier_status_matrix_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "risk_tier_code" VARCHAR(30),
...
CREATE TABLE IF NOT EXISTS "l3"."limit_counterparty_movement" (
    "limit_counterparty_movement_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "risk_tier_code" VARCHAR(30),
...
CREATE TABLE IF NOT EXISTS "l3"."data_quality_score_summary" (
    "data_quality_score_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."legal_entity_risk_profile" (
    "legal_entity_risk_profile_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."data_quality_attribute_score" (
    "data_quality_attribute_score_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."data_quality_trend" (
    "data_quality_trend_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "data_quality_score_pct" NUMERIC(10,6),
...
CREATE TABLE IF NOT EXISTS "l3"."stress_test_result_summary" (
    "stress_test_result_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."stress_test_breach_detail" (
    "stress_test_breach_detail_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "breach_seq" INTEGER,
...
CREATE TABLE IF NOT EXISTS "l3"."regulatory_compliance_state" (
    "regulatory_compliance_state_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "metric_id" VARCHAR(64),
    "metric_name" VARCHAR(500),
...
CREATE TABLE IF NOT EXISTS "l3"."facility_timeline_summary" (
    "facility_timeline_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."amendment_summary" (
    "amendment_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "amendment_type_code" VARCHAR(30),
...
CREATE TABLE IF NOT EXISTS "l3"."amendment_detail" (
    "amendment_detail_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."facility_detail_snapshot" (
    "facility_detail_snapshot_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "facility_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_risk_ratio_summary" (
    "lob_risk_ratio_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_deterioration_summary" (
    "lob_deterioration_summary_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_rating_distribution" (
    "lob_rating_distribution_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."lob_top_contributors" (
    "lob_top_contributors_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."metric_value_fact" (
    "metric_value_fact_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "metric_id" VARCHAR(64),
...
-- calc_audit_log (Calculation Engine)
...
-- calc_validation_result (Calculation Engine)
...
-- metric_result (Calculation Engine)
...
CREATE TABLE IF NOT EXISTS "l3"."counterparty_derived" (
    "counterparty_derived_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "facility_id" BIGINT,
    "counterparty_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."desk_derived" (
    "desk_derived_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."facility_derived" (
    "facility_derived_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "facility_id" BIGINT,
    "as_of_date" DATE,
    "counterparty_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."portfolio_derived" (
    "portfolio_derived_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
    "as_of_date" DATE,
...
CREATE TABLE IF NOT EXISTS "l3"."segment_derived" (
    "segment_derived_sk" BIGINT NOT NULL,
    "run_version_id" BIGINT,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
    "as_of_date" DATE,
...
-- data_quality_score_snapshot (Uncategorized)
...
-- stress_test_result (Uncategorized)
