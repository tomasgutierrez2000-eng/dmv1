...
-- collateral_calc (Collateral & Risk Mitigation)
...
-- counterparty_rating_calc (Credit Risk & Ratings)
...
-- ecl_allowance_movement (Credit Risk & Ratings)
CREATE TABLE IF NOT EXISTS "l3"."ecl_allowance_movement" (
    "allowance_movement_id" BIGINT NOT NULL,
...
-- ecl_provision_calc (Credit Risk & Ratings)
CREATE TABLE IF NOT EXISTS "l3"."ecl_provision_calc" (
    "ecl_provision_id" BIGINT NOT NULL,
    "facility_id" BIGINT,
...
-- facility_exposure_calc (Exposure & Position)
CREATE TABLE IF NOT EXISTS "l3"."facility_exposure_calc" (
    ...
    "load_timestamp" TIMESTAMP,
    "load_batch_id" VARCHAR(100),
    "total_collateral_mv_usd" NUMERIC(20,4),
    "run_id" VARCHAR(64),
    "model_version" VARCHAR(64),
    PRIMARY KEY ("facility_id", "as_of_date")
);

-- facility_financial_calc (Financial Performance)
...
-- facility_pricing_calc (Financial Performance)
...
-- gl_account_balance_calc (Financial Performance)
...
-- watchlist_movement_summary (Credit Risk & Ratings)
CREATE TABLE IF NOT EXISTS "l3"."watchlist_movement_summary" (
    "movement_summary_id" BIGINT NOT NULL,
    "as_of_date" DATE,
...
-- exposure_metric_cube (Exposure & Position)
CREATE TABLE IF NOT EXISTS "l3"."exposure_metric_cube" (
    "exposure_metric_cube_sk" VARCHAR(64) NOT NULL,
...
-- risk_metric_cube (Exposure & Position)
CREATE TABLE IF NOT EXISTS "l3"."risk_metric_cube" (
    "risk_metric_cube_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
-- counterparty_exposure_summary (Exposure & Position)
CREATE TABLE IF NOT EXISTS "l3"."counterparty_exposure_summary" (
    "counterparty_exposure_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
-- facility_exposure_summary (Exposure & Position)
CREATE TABLE IF NOT EXISTS "l3"."facility_exposure_summary" (
    "facility_exposure_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
-- portfolio_summary (Exposure & Position)
CREATE TABLE IF NOT EXISTS "l3"."portfolio_summary" (
    "portfolio_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
-- crm_allocation_summary (Collateral & Risk Mitigation)
CREATE TABLE IF NOT EXISTS "l3"."crm_allocation_summary" (
    "crm_allocation_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
-- collateral_portfolio_valuation (Collateral & Risk Mitigation)
CREATE TABLE IF NOT EXISTS "l3"."collateral_portfolio_valuation" (
    "collateral_portfolio_valuation_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "legal_entity_id" BIGINT,
...
-- limit_current_state (Limits & Risk Appetite)
CREATE TABLE IF NOT EXISTS "l3"."limit_current_state" (
    "limit_current_state_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_ts" TIMESTAMP,
    "legal_entity_id" BIGINT,
...
-- limit_utilization_timeseries (Limits & Risk Appetite)
CREATE TABLE IF NOT EXISTS "l3"."limit_utilization_timeseries" (
    "limit_utilization_timeseries_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_ts" TIMESTAMP,
    "legal_entity_id" BIGINT,
    "limit_assignment_id" BIGINT,
...
-- limit_attribution_summary (Limits & Risk Appetite)
CREATE TABLE IF NOT EXISTS "l3"."limit_attribution_summary" (
    "limit_attribution_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_ts" TIMESTAMP,
    "legal_entity_id" BIGINT,
    "limit_assignment_id" BIGINT,
...
-- limit_breach_fact (Limits & Risk Appetite)
CREATE TABLE IF NOT EXISTS "l3"."limit_breach_fact" (
    "limit_breach_fact_sk" VARCHAR(64) NOT NULL,
    "breach_id" BIGINT,
    "run_version_id" BIGINT,
    "limit_assignment_id" BIGINT,
    "legal_entity_id" BIGINT,
...
-- credit_event_summary (Credit Risk & Ratings)
CREATE TABLE IF NOT EXISTS "l3"."credit_event_summary" (
    "credit_event_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "counterparty_id" BIGINT,
...
-- rating_migration_summary (Credit Risk & Ratings)
CREATE TABLE IF NOT EXISTS "l3"."rating_migration_summary" (
    "rating_migration_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "counterparty_id" BIGINT,
...
-- default_loss_recovery_summary (Credit Risk & Ratings)
CREATE TABLE IF NOT EXISTS "l3"."default_loss_recovery_summary" (
    "default_loss_recovery_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "counterparty_id" BIGINT,
...
-- report_run (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."report_run" (
    "report_run_sk" VARCHAR(64) NOT NULL,
...
-- report_cell_value (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."report_cell_value" (
    "report_cell_value_sk" VARCHAR(64) NOT NULL,
    "report_run_id" BIGINT,
    "cell_id" BIGINT,
...
-- report_cell_contribution_fact (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."report_cell_contribution_fact" (
    "report_cell_contribution_fact_sk" VARCHAR(64) NOT NULL,
...
-- report_cell_rule_execution (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."report_cell_rule_execution" (
    "report_cell_rule_execution_sk" VARCHAR(64) NOT NULL,
    "report_run_id" BIGINT,
    "cell_id" BIGINT,
    "rule_id" BIGINT,
...
-- report_validation_result (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."report_validation_result" (
    "report_validation_result_sk" VARCHAR(64) NOT NULL,
...
-- fr2590_position_snapshot (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."fr2590_position_snapshot" (
    "fr2590_position_snapshot_sk" VARCHAR(64) NOT NULL,
    "report_run_id" BIGINT,
    "position_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
...
-- fr2590_counterparty_aggregate (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."fr2590_counterparty_aggregate" (
    "fr2590_counterparty_aggregate_sk" VARCHAR(64) NOT NULL,
    "report_run_id" BIGINT,
    "counterparty_id" BIGINT,
    "legal_entity_id" BIGINT,
    "as_of_date" DATE,
...
-- lob_exposure_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_exposure_summary" (
    "lob_exposure_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- lob_profitability_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_profitability_summary" (
    "lob_profitability_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- lob_pricing_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_pricing_summary" (
    "lob_pricing_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- lob_delinquency_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_delinquency_summary" (
    "lob_delinquency_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
    ...
    "run_id" VARCHAR(64),
    "model_version" VARCHAR(64),
    "overdue_amt_current" NUMERIC(20,4),
    "overdue_amt_1_29" NUMERIC(20,4),
    "overdue_amt_30_59" NUMERIC(20,4),
    "overdue_amt_60_89" NUMERIC(20,4),
    "overdue_amt_90_plus" NUMERIC(20,4),
    PRIMARY KEY ("lob_delinquency_summary_sk")
);

-- lob_profitability_allocation_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_profitability_allocation_summary" (
    "lob_profitability_allocation_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- deal_pipeline_stage_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."deal_pipeline_stage_summary" (
    "deal_pipeline_stage_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- lob_credit_quality_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_credit_quality_summary" (
    "lob_credit_quality_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- kpi_period_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."kpi_period_summary" (
    "kpi_period_summary_sk" VARCHAR(64) NOT NULL,
    "kpi_code" VARCHAR(30),
    "as_of_date" DATE,
...
-- risk_appetite_metric_state (Limits & Risk Appetite)
CREATE TABLE IF NOT EXISTS "l3"."risk_appetite_metric_state" (
    "risk_appetite_metric_state_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
-- executive_highlight_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."executive_highlight_summary" (
    "executive_highlight_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
-- counterparty_detail_snapshot (Counterparty & Entity)
CREATE TABLE IF NOT EXISTS "l3"."counterparty_detail_snapshot" (
    "counterparty_detail_snapshot_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "counterparty_id" BIGINT,
...
-- limit_tier_status_matrix (Limits & Risk Appetite)
CREATE TABLE IF NOT EXISTS "l3"."limit_tier_status_matrix" (
    "limit_tier_status_matrix_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "risk_tier_code" VARCHAR(30),
...
-- limit_counterparty_movement (Limits & Risk Appetite)
CREATE TABLE IF NOT EXISTS "l3"."limit_counterparty_movement" (
    "limit_counterparty_movement_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "risk_tier_code" VARCHAR(30),
...
-- data_quality_score_summary (Data Quality & Infrastructure)
CREATE TABLE IF NOT EXISTS "l3"."data_quality_score_summary" (
    "data_quality_score_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
-- legal_entity_risk_profile (Counterparty & Entity)
CREATE TABLE IF NOT EXISTS "l3"."legal_entity_risk_profile" (
    "legal_entity_risk_profile_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
...
-- data_quality_attribute_score (Data Quality & Infrastructure)
CREATE TABLE IF NOT EXISTS "l3"."data_quality_attribute_score" (
    "data_quality_attribute_score_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
-- data_quality_trend (Data Quality & Infrastructure)
CREATE TABLE IF NOT EXISTS "l3"."data_quality_trend" (
    "data_quality_trend_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "legal_entity_id" BIGINT,
    "data_quality_score_pct" NUMERIC(10,6),
...
CREATE TABLE IF NOT EXISTS "l3"."stress_test_result_summary" (
    "stress_test_result_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
...
CREATE TABLE IF NOT EXISTS "l3"."stress_test_breach_detail" (
    "stress_test_breach_detail_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "scenario_id" BIGINT,
    "breach_seq" INTEGER,
...
-- regulatory_compliance_state (Regulatory & Capital)
CREATE TABLE IF NOT EXISTS "l3"."regulatory_compliance_state" (
    "regulatory_compliance_state_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "metric_id" VARCHAR(64),
    "metric_name" VARCHAR(500),
...
-- facility_timeline_summary (Financial Performance)
CREATE TABLE IF NOT EXISTS "l3"."facility_timeline_summary" (
    "facility_timeline_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
-- amendment_summary (Amendments & Forbearance)
CREATE TABLE IF NOT EXISTS "l3"."amendment_summary" (
    "amendment_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "amendment_type_code" VARCHAR(30),
...
-- amendment_detail (Amendments & Forbearance)
CREATE TABLE IF NOT EXISTS "l3"."amendment_detail" (
    "amendment_detail_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
...
-- facility_detail_snapshot (Financial Performance)
CREATE TABLE IF NOT EXISTS "l3"."facility_detail_snapshot" (
    "facility_detail_snapshot_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "facility_id" BIGINT,
...
-- lob_risk_ratio_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_risk_ratio_summary" (
    "lob_risk_ratio_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- lob_deterioration_summary (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_deterioration_summary" (
    "lob_deterioration_summary_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- lob_rating_distribution (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_rating_distribution" (
    "lob_rating_distribution_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- lob_top_contributors (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."lob_top_contributors" (
    "lob_top_contributors_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
...
-- metric_value_fact (Data Quality & Infrastructure)
CREATE TABLE IF NOT EXISTS "l3"."metric_value_fact" (
    "metric_value_fact_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "as_of_date" DATE,
    "metric_id" VARCHAR(64),
...
-- calc_audit_log (Data Quality & Infrastructure)
...
-- calc_run (Data Quality & Infrastructure)
...
-- calc_validation_result (Data Quality & Infrastructure)
...
-- metric_result (Data Quality & Infrastructure)
...
-- facility_risk_calc (Exposure & Position)
...
-- netting_set_exposure_calc (Exposure & Position)
...
CREATE TABLE IF NOT EXISTS "l3"."facility_stress_test_calc" (
    "facility_stress_test_calc_id" BIGINT NOT NULL,
    "position_id" BIGINT,
    "facility_id" BIGINT,
    "counterparty_id" BIGINT,
    "scenario_id" BIGINT,
...
-- capital_position_calc (Regulatory & Capital)
...
-- counterparty_financial_calc (Counterparty & Entity)
...
-- exception_event_calc (Limits & Risk Appetite)
...
-- counterparty_derived (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."counterparty_derived" (
    "counterparty_derived_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "facility_id" BIGINT,
    "counterparty_id" BIGINT,
    "as_of_date" DATE,
...
-- desk_derived (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."desk_derived" (
    "desk_derived_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
    "as_of_date" DATE,
...
-- facility_derived (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."facility_derived" (
    "facility_derived_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "facility_id" BIGINT,
    "as_of_date" DATE,
    "counterparty_id" BIGINT,
...
-- portfolio_derived (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."portfolio_derived" (
    "portfolio_derived_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
    "as_of_date" DATE,
...
-- segment_derived (Business Segment & Dashboard)
CREATE TABLE IF NOT EXISTS "l3"."segment_derived" (
    "segment_derived_sk" VARCHAR(64) NOT NULL,
    "run_version_id" BIGINT,
    "hierarchy_id" BIGINT,
    "lob_node_id" BIGINT,
    "as_of_date" DATE,
...
-- data_quality_score_calc (Data Quality & Infrastructure)
...
-- metric_change_log (Uncategorized)
...
-- metric_sandbox_run (Uncategorized)
...
-- schema_change_log (Uncategorized)
...
-- cross_product_accounting_view (Uncategorized)
...
-- cross_product_risk_view (Uncategorized)
...
-- facility_position_agg (Uncategorized)
...
-- position_exposure_calc (Uncategorized)
