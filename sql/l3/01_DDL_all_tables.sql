...
-- ============================================================================
-- T67-T71: Dashboard Consumption Derived Tables
-- Consolidated wide tables per rollup level for CRO dashboard single-source reads.
-- ============================================================================

-- facility_derived (Dashboard Consumption)
...
-- counterparty_derived (Dashboard Consumption)
...
-- desk_derived (Dashboard Consumption)
...
-- portfolio_derived (Dashboard Consumption)
...
-- segment_derived (Dashboard Consumption)
